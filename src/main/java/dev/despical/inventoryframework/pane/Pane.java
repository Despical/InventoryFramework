package dev.despical.inventoryframework.pane;
...
import dev.despical.inventoryframework.exception.XMLReflectionException;
import dev.despical.inventoryframework.util.SkullUtil;
...
public abstract class Pane {
    ...
    protected static <T extends GuiItem> T findMatchingItem(@NotNull Collection<T> items, @NotNull ItemStack item) {
        return items.stream().filter(guiItem -> {
            ...
            String stringUUID = nbtItem.getString("IF-uuid");
